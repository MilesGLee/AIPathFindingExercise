...
Maze::TileKey e = Maze::TileKey::GUARD;
Maze::TileKey c = Maze::TileKey::WAYPOINT;
...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, w },
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, w, w, w, w, w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, w, w, _, _, _, w, w, w, w, w, w, w, w, w, w, _, _, _, w },
		{ w, _, _, _, w, w, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, p, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
	};
...
DynamicArray<Actor*> Maze::getWaypoints()
{
	return m_waypoints;
}
...
Maze::Tile Maze::createTile(int x, int y, TileKey key)
{
	...
	case TileKey::WALL:
		...
		addActor(tile.actor);
		break;
	case TileKey::WAYPOINT:
		tile.cost = 1.0f;
		tile.actor = new Waypoint(position.x, position.y);
		tile.node->walkable = true;
		m_waypoints.addItem(tile.actor);
		addActor(tile.actor);
		break;
	case TileKey::PLAYER:
		tile.cost = 1.0f;
